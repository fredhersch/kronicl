          ...
          {isNewMemoryPage ? (
            ...
            <Link href="/memories/new" className="flex flex-col items-center p-2 rounded-xl transition-all duration-300 hover:scale-105 -translate-y-7">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-6 h-6 rounded-full flex items-center justify-center shadow-lg bg-red-500 animate-pulse">
                  <span className="text-xs font-bold text-white">+</span>
                </div>
              </div>
              <span className="text-sm font-bold mt-4 text-indigo-600">
                New
              </span>
            </Link>
          )}

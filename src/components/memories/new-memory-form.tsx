...
export function NewMemoryForm({ userId }: { userId: string }) {
  ...
  const addMediaFiles = async (newFiles: File[]) => {
    ...
    logDebug('Validating file selection', {
      ...
      imageCount,
      videoCount,
      isValid: !(videoCount > 1 || (videoCount > 0 && imageCount > 0) || imageCount > 6),
      timestamp: new Date().toISOString()
    });

    if (videoCount > 1 || (videoCount > 0 && imageCount > 0) || imageCount > 6) {
      ...
      toast({
        ...
        description: 'You can upload up to 6 images or 1 video.',
      });
      return;
    }
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pb-24">
        ...
        {/* Media Upload - Optional and first */}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  ...
                  <p>• You can upload up to 6 images or 1 video</p>

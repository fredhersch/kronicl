          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-slate-600 space-y-3 leading-relaxed">
                <p>
                  By using Memory Lane, you agree to these terms and conditions. Memory Lane is a service 
                ...
                <p>
                  <strong>Content:</strong> You retain ownership of all content you upload to Memory Lane. 
                  We will not share your personal memories with third parties without your consent.
                </p>
                <p>
                  <strong>Service Availability:</strong> We strive to keep Memory Lane available 24/7, 
                  but we cannot guarantee uninterrupted service.
                </p>
                <p>
                  <strong>Prohibited Use:</strong> You may not use Memory Lane for any illegal activities 
